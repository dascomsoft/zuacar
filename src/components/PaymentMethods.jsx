...
// export default function PaymentMethods({ reservation, reservationId }) {
...
//     setConfirming(true);
//     try {
//       // 1. Confirmer le paiement dans la base de données
...
//         alert('Paiement confirmé ! Un email vous a été envoyé.');
